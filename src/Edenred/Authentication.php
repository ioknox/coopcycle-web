...
{
    const JWT_CLAIM_SUCCESS_REDIRECT = 'https://coopcycle.org/edenred_success_redirect';
    const JWT_CLAIM_FAILURE_REDIRECT = 'https://coopcycle.org/edenred_failure_redirect';
